...
def skip_next_btn(driver):
    ...
    next_btn = '//*[@id="appMountPoint"]/div/div/div[1]/div[8]/div[2]/div[3]/div[2]/div/div/div[3]/div/div[3]/div[2]/button'
    ## 영어, 일어
    ...
    with tqdm(total = total_episode) as process:
        ...
        while ep_cnt < total_episode:
            ...
            for lang in langs:
                ## -----------lang 변경----------- ##
                # print(lang.text)
                if lang.text == "중국어(간체)" or lang.text == "중국어(간체) [CC]":
                # if lang.text == "중국어(번체)":
                    lang.click()
                    time.sleep(4)
                    break
...
## en-ko / ko-en / ja-ko
trans_lang(r"https://www.netflix.com/watch/81312811?trackId=255824129",8)

# ko-ja / ko-zh / zh-ko = 자막 언어 변경 후 적용
# change_cc(r"https://www.netflix.com/watch/81573832?trackId=255824129",20)
